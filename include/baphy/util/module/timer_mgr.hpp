...
public:
  ...
  std::string every(const std::string &tag, const std::vector<double> &delay_opts, std::int64_t count, T &&f, T2 &&after_f = T2());
  ...
  std::string until(const std::string &tag, const std::vector<double> &delay_opts, std::int64_t count, T &&f, T2 &&after_f = T2());
...
private:
  ...
  struct EveryTimer : public TimerI {
    ...
    EveryTimer(const std::vector<double> &delay_opts, std::int64_t count, EveryFunc &&f, AfterFunc &&f2)
        : TimerI(rnd::choose(delay_opts)), delay_opts(delay_opts), count(count), f(std::forward<EveryFunc>(f)), f2(std::forward<AfterFunc>(f2)) {}
  ...
  struct UntilTimer : public TimerI {
    ...
    UntilTimer(const std::vector<double> &delay_opts, std::int64_t count, UntilFunc &&f, AfterFunc &&f2)
        : TimerI(rnd::choose(delay_opts)), delay_opts(delay_opts), count(count), f(std::forward<UntilFunc>(f)), f2(std::forward<AfterFunc>(f2)) {}
...
std::string TimerMgr::every(const std::string &tag, const std::vector<double> &delay_opts, std::int64_t count, T &&f, T2 &&after_f) {
...
std::string TimerMgr::until(const std::string &tag, const std::vector<double> &delay_opts, std::int64_t count, T &&f, T2 &&after_f) {
