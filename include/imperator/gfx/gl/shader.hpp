#ifndef IMPERATOR_GFX_GL_SHADER_HPP
#define IMPERATOR_GFX_GL_SHADER_HPP
...
public:
  ...
  void uniform_4u(const std::string& uniform_name, unsigned int v0, unsigned int v1, unsigned int v2, unsigned int v3);
...
#endif//IMPERATOR_GFX_GL_SHADER_HPP
