...
XYZ RGB::to_xyz() const {
  ...
  rd = (rd > 0.04045) ? std::pow(((rd + 0.055) / 1.055), 2.4)
                      : rd / 12.92;
  gd = (gd > 0.04045) ? std::pow(((gd + 0.055) / 1.055), 2.4)
                      : gd / 12.92;
  bd = (bd > 0.04045) ? std::pow(((bd + 0.055) / 1.055), 2.4)
                      : bd / 12.92;
...
RGB XYZ::to_rgb() const {
  ...
  rd = (rd > 0.0031308) ? 1.055 * (std::pow(rd, 1.0 / 2.4)) - 0.055
                        : 12.92 * rd;
  gd = (gd > 0.0031308) ? 1.055 * (std::pow(gd, 1.0 / 2.4)) - 0.055
                        : 12.92 * gd;
  bd = (bd > 0.0031308) ? 1.055 * (std::pow(bd, 1.0 / 2.4)) - 0.055
                        : 12.92 * bd;
...
CIELab XYZ::to_lab() const {
  ...
  lx = (lx > 0.008856) ? std::pow(lx, 1.0 / 3.0)
                       : (7.787 * lx) + (16.0 / 116.0);
  ly = (ly > 0.008856) ? std::pow(ly, 1.0 / 3.0)
                       : (7.787 * ly) + (16.0 / 116.0);
  lz = (lz > 0.008856) ? std::pow(lz, 1.0 / 3.0)
                       : (7.787 * lz) + (16.0 / 116.0);
...
CIELCh CIELab::to_lch() const {
  ...
  h = (h > 0.0) ? (h / std::numbers::pi) * 180.0
