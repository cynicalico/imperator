...
void GfxContext::set_vsync(bool v) {
    if (use_platform_extensions_) { platform_set_vsync_(v); }
    else { glfwSwapInterval(v ? 1 : 0); }
}
...
#define STRINGIFY(e) case e: return #e;
    ...
    switch (severity) {
        case GL_DEBUG_SEVERITY_HIGH:IMPERATOR_LOG_ERROR(
            ...
            break;
        case GL_DEBUG_SEVERITY_MEDIUM:IMPERATOR_LOG_WARN(
                    "OpenGL: source={} type={} id={} msg={}",
                    source_str.substr(9),
                    type_str.substr(9),
                    id,
            ...
            break;
        case GL_DEBUG_SEVERITY_LOW:IMPERATOR_LOG_DEBUG(
                    "OpenGL: source={} type={} id={} msg={}",
                    source_str.substr(9),
                    type_str.substr(9),
                    id,
            ...
            break;
        case GL_DEBUG_SEVERITY_NOTIFICATION:IMPERATOR_LOG_TRACE(
                    "OpenGL: source={} type={} id={} msg={}",
                    source_str.substr(9),
                    type_str.substr(9),
                    id,
